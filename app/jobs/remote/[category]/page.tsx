...
export async function generateMetadata({ params }: { params: { category: string } }): Promise<Metadata> {
  ...
  const url = `https://www.remote.jobmeter.app/jobs/remote/${page.slug}`;
...
export default async function RemoteCategoryPage({ params }: { params: { category: string } }) {
  ...
  const jsonLd = {
    ...
    name: h1,
    description,
    url: `https://www.remote.jobmeter.app/jobs/remote/${page.slug}`,
    breadcrumb: {
      '@type': 'BreadcrumbList',
      itemListElement: [
        { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://www.remote.jobmeter.app' },
        { '@type': 'ListItem', position: 2, name: 'Jobs', item: 'https://www.remote.jobmeter.app/jobs' },
        { '@type': 'ListItem', position: 3, name: 'Remote Jobs', item: 'https://www.remote.jobmeter.app/jobs/remote' },
        { '@type': 'ListItem', position: 4, name: h1, item: `https://www.remote.jobmeter.app/jobs/remote/${page.slug}` },
      ],
    },
  };
